...
public class Product implements
    ...
    public void initMethod() {
        System.out.printf(
                "4. @Bean, свойство initMethod: выполняются действия при инициализация бина '%s'%n", beanName);
    }
    ...
    public void destroyMethod() {
        System.out.printf(
                "6. @Bean, свойство destroyMethod: - выполняются действия при уничтожении бина '%s'%n", beanName);
    }
